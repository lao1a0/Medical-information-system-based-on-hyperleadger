...
async function Query(callback) {
    try {
        ...
        const walletPath = path.join("/home/lao/GOPATH/src/github.com/hyperledger/fabric/scripts/fabric-samples/fabcar/javascript", 'wallet');
        ...
        callback(`Transaction has been evaluated, result is: ${result.toString()}`);
